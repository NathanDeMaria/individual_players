...
class DefenseAdjustedCallback:
    def __init__(
        ...
        # TODO: should the adjusted ratings have a different prior?
        self._adjusted_offense_rating: PlayerRatings = defaultdict(
            lambda: (offense_model.vpp_mean, offense_model.vpp_variance)
        )
